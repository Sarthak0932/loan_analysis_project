...
loan_analysis.ipynb -The main Jupyter Notebook containing all data cleaning, EDA, model training, and final comparison logic.

requirements.txt- Lists all necessary Python libraries for recreating the environment.
...
git clone [https://github.com/Sarthak0932/loan_analysis_project.git]
